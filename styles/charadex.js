const charadex = (options) => {
  ...
  ======================================================================= */
  const charadexInfo = {
    sheetID: userOptions.sheetID ? userOptions.sheetID.includes('/d/') ? userOptions.sheetID.split('/d/')[1].split('/edit')[0] : userOptions.sheetID : "1LITgajFkPXhrxwwe8HxBBbBBajyOvsimtOpiOYIuS8M",
    ...
    itemOrder: userOptions.itemOrder ? userOptions.itemOrder : "asc",
